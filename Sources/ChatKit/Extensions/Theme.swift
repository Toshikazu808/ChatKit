...
@MainActor public enum Theme {
    public internal(set) static var babyBlue = Color(red: 0.941, green: 0.98, blue: 0988)
    public internal(set) static var lightGray = Color(red: 0.839, green: 0.839, blue: 0.839)
    public internal(set) static var silver = Color(red: 0.043, green: 0.298, blue: 0.376)
    public internal(set) static var lightNavy = Color(red: 0.043, green: 0.298, blue: 0.376)
}
